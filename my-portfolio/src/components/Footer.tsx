        ...
        <div className="flex justify-center text-center w-full">
            <div className="flex flex-col w-full max-w-screen-xl bg-accent-1">
                ...
                <div className="flex flex-col-reverse md:flex-row justify-between p-8 gap-8">
                    <h1 className='text-md flex justify-center items-center text-primary-1'>© 2023{nbsp}<a href="https://andrei-sager-portfolio.vercel.app" className='underline text-neutral-2'>Andrei Sager</a>{nbsp}& Alexei. All Rights Reserved.</h1>
