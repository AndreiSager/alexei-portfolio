    ...
    return (
        <div className='flex flex-wrap justify-center'>
            <div className="py-16 flex flex-wrap justify-center items-center gap-12 text-center max-w-screen-lg">
                <img
                    src="https://ik.imagekit.io/alyujsrzv/Alexei-Portfolio/compressed/me.jpg"
                    srcSet={`
                        https://ik.imagekit.io/alyujsrzv/Alexei-Portfolio/tr:w-400/compressed/me.jpg?width=400 400w,
                        https://ik.imagekit.io/alyujsrzv/Alexei-Portfolio/tr:w-800/compressed/me.jpg?width=800 800w,
                        https://ik.imagekit.io/alyujsrzv/Alexei-Portfolio/tr:w-1200/compressed/me.jpg?width=1200 1200w
                    `}
